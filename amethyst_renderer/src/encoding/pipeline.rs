...
use amethyst_assets::{Asset, Handle, NewProcessingState, ProcessingState, Result};
...
impl Into<Result<NewProcessingState<EncodingLayout, EncodingLayout>>> for EncodingLayout {
    fn into(self) -> Result<NewProcessingState<EncodingLayout, EncodingLayout>> {
